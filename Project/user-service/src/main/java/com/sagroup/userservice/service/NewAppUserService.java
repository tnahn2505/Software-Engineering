...
public class NewAppUserService {
    ...
    @CircuitBreaker(name = "generateResetTokenCB", fallbackMethod = "generateResetTokenFallback")
    @Retry(name = "generateResetTokenRetry")
    ...
    public void generateResetTokenFallback(String email, Exception ex) {
        // Có thể log lỗi hoặc gửi thông báo khác
        System.out.println("[Fallback] Không thể gửi mã reset cho email: " + email + ". Lý do: " + ex.getMessage());
    }
